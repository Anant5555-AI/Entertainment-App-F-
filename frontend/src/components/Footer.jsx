...
const Footer = () => {
  return (
    <footer className='bg-[#18181B] border-t border-gray-800 mt-20'>
      <div className='px-4 md:px-8 lg:px-[100px] py-8 md:py-12'>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8'>
          {/* About Section */}
          <div className='col-span-1 md:col-span-2'>
            <h3 className='text-2xl font-bold text-white mb-4'>Entertainment App</h3>
            <p className='text-gray-400 mb-4 max-w-md'>
              Your ultimate destination for streaming the best movies and entertainment. 
              Watch unlimited movies, discover new releases, and enjoy premium content.
            </p>
          ...
          <div>
            ...
            <ul className='space-y-2'>
              ...
              <li>
                <Link to='/' className='text-gray-400 hover:text-white transition-colors'>Movies</Link>
              </li>
              <li>
        ...
        <div className='border-t border-gray-800 mt-6 md:mt-8 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4'>
          <p className='text-gray-400 text-sm'>
            {new Date().getFullYear()} Entertainment App. All rights reserved.
          </p>
